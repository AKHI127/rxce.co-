...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    private View wrapInBottomSheet(int i, View view, ViewGroup.LayoutParams layoutParams) {
        ...
        FrameLayout container = (FrameLayout) View.inflate(getContext(), C0387R.layout.design_bottom_sheet_dialog, (ViewGroup) null);
        CoordinatorLayout coordinator = (CoordinatorLayout) container.findViewById(C0387R.C0389id.coordinator);
        if (layoutResId != 0 && view2 == null) {
            view2 = getLayoutInflater().inflate(layoutResId, coordinator, false);
        }
        FrameLayout bottomSheet = (FrameLayout) coordinator.findViewById(C0387R.C0389id.design_bottom_sheet);
        ...
        coordinator.findViewById(C0387R.C0389id.touch_outside).setOnClickListener(onClickListener);
    ...
    private static int getThemeResId(Context context, int i) {
        ...
        if (themeId == 0) {
            ...
            if (context2.getTheme().resolveAttribute(C0387R.attr.bottomSheetDialogTheme, outValue, true)) {
                themeId = outValue.resourceId;
            } else {
                themeId = C0387R.style.Theme_Design_Light_BottomSheetDialog;
            }
        }
        return themeId;
    }
