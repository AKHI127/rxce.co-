...
public class CircularBorderDrawable extends Drawable {
    ...
    final Rect rect;
    final RectF rectF;
    @FloatRange(from = 0.0d, mo51to = 360.0d)
    ...
    public CircularBorderDrawable() {
        ...
        new RectF();
        this.rectF = rectF2;
        new CircularBorderState(this, (C04281) null);
    ...
    public void setAlpha(@IntRange(from = 0, mo57to = 255) int alpha) {
    ...
    private class CircularBorderState extends Drawable.ConstantState {
        ...
        /* synthetic */ CircularBorderState(CircularBorderDrawable x0, C04281 r7) {
            this(x0);
            C04281 r2 = r7;
        }
