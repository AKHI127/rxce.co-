...
public final class ThemeEnforcement {
    private static final int[] APPCOMPAT_CHECK_ATTRS = {C0387R.attr.colorPrimary};
    private static final String APPCOMPAT_THEME_NAME = "Theme.AppCompat";
    private static final int[] MATERIAL_CHECK_ATTRS = {C0387R.attr.colorSecondary};
    ...
    private static void checkCompatibleTheme(Context context, AttributeSet set, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
        Context context2 = context;
        TypedArray a = context2.obtainStyledAttributes(set, C0387R.styleable.ThemeEnforcement, defStyleAttr, defStyleRes);
        boolean enforceMaterialTheme = a.getBoolean(C0387R.styleable.ThemeEnforcement_enforceMaterialTheme, false);
        a.recycle();
    ...
    private static void checkTextAppearance(Context context, AttributeSet attributeSet, @StyleableRes int[] iArr, @AttrRes int i, @StyleRes int i2, @StyleableRes int... iArr2) {
        ...
        TypedArray themeEnforcementAttrs = context2.obtainStyledAttributes(set, C0387R.styleable.ThemeEnforcement, defStyleAttr, defStyleRes);
        if (!themeEnforcementAttrs.getBoolean(C0387R.styleable.ThemeEnforcement_enforceTextAppearance, false)) {
            themeEnforcementAttrs.recycle();
            return;
        }
        if (textAppearanceResIndices == null || textAppearanceResIndices.length == 0) {
            validTextAppearance = themeEnforcementAttrs.getResourceId(C0387R.styleable.ThemeEnforcement_android_textAppearance, -1) != -1;
        } else {
