...
final class IndicatorViewController {
    ...
    private final float captionTranslationYPx = ((float) this.context.getResources().getDimensionPixelSize(C0387R.dimen.design_textinput_caption_translate_y));
    ...
    public void setErrorEnabled(boolean z) {
        ...
        if (this.errorEnabled != enabled) {
            ...
            if (enabled) {
                ...
                this.errorView.setId(C0387R.C0389id.textinput_error);
    ...
    public void setHelperTextEnabled(boolean z) {
        ...
        if (this.helperTextEnabled != enabled) {
            ...
            if (enabled) {
                ...
                this.helperTextView.setId(C0387R.C0389id.textinput_helper_text);
                if (this.typeface != null) {
