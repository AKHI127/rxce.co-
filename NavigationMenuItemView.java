...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
    ...
    public NavigationMenuItemView(android.content.Context r10, android.util.AttributeSet r11, int r12) {
        /*
            ...
            int r5 = com.google.android.material.C0387R.layout.design_navigation_menu_item
            r6 = r0
            r7 = 1
            ...
            int r6 = com.google.android.material.C0387R.dimen.design_navigation_icon_size
            int r5 = r5.getDimensionPixelSize(r6)
            r4.iconSize = r5
            r4 = r0
            r5 = r0
            int r6 = com.google.android.material.C0387R.C0389id.design_menu_item_text
    ...
    private void setActionView(View view) {
        ...
        if (actionView != null) {
            if (this.actionArea == null) {
                this.actionArea = (FrameLayout) ((ViewStub) findViewById(C0387R.C0389id.design_menu_item_action_area_stub)).inflate();
            }
            this.actionArea.removeAllViews();
    ...
    private StateListDrawable createDefaultBackground() {
        ...
        if (!getContext().getTheme().resolveAttribute(C0002R.attr.colorControlHighlight, value, true)) {
            return null;
        }
    ...
    public void setIcon(Drawable drawable) {
        ...
        if (icon != null) {
            ...
            if (this.emptyDrawable == null) {
                this.emptyDrawable = ResourcesCompat.getDrawable(getResources(), C0387R.C0388drawable.navigation_empty_icon, getContext().getTheme());
                if (this.emptyDrawable != null) {
