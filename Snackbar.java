...
public final class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    private static final int[] SNACKBAR_BUTTON_STYLE_ATTR = {C0387R.attr.snackbarButtonStyle};
    ...
    public static Snackbar make(@NonNull View view, @NonNull CharSequence charSequence, int i) {
        ...
        SnackbarContentLayout content = (SnackbarContentLayout) LayoutInflater.from(parent.getContext()).inflate(hasSnackbarButtonStyleAttr(parent.getContext()) ? C0387R.layout.mtrl_layout_snackbar_include : C0387R.layout.design_layout_snackbar_include, parent, false);
